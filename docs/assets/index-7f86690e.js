...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */var Br=function(){return Br=Object.assign||function(e){for(var n,r=1,i=arguments.length;r<i;r++){n=arguments[r];for(var s in n)Object.prototype.hasOwnProperty.call(n,s)&&(e[s]=n[s])}return e},Br.apply(this,arguments)},Mw=function(t){return{loading:t==null,value:t}},uR=function(){return function(t,e){switch(e.type){case"error":return Br(Br({},t),{error:e.error,loading:!1,value:void 0});case"reset":return Mw(e.defaultValue);case"value":return Br(Br({},t),{error:void 0,loading:!1,value:e.value});default:return t}}},cR=function(t){var e=t?t():void 0,n=oe.useReducer(uR(),Mw(e)),r=n[0],i=n[1],s=oe.useCallback(function(){var l=t?t():void 0;i({type:"reset",defaultValue:l})},[t]),o=oe.useCallback(function(l){i({type:"error",error:l})},[]),a=oe.useCallback(function(l){i({type:"value",value:l})},[]);return oe.useMemo(function(){return{error:r.error,loading:r.loading,reset:s,setError:o,setValue:a,value:r.value}},[r.error,r.loading,s,o,a,r.value])},hR=function(t,e,n){var r=oe.useRef(t);return oe.useEffect(function(){e(t,r.current)||(r.current=t,n&&n())}),r},dR=function(t,e){var n=!t&&!e,r=!!t&&!!e&&VA(t,e);return n||r},fR=function(t,e){return hR(t,dR,e)},pR=function(t,e){var n=cR(),r=n.error,i=n.loading,s=n.reset,o=n.setError,a=n.setValue,l=n.value,u=fR(t,s);return oe.useEffect(function(){if(!u.current){a(void 0);return}var c=e!=null&&e.snapshotListenOptions?hg(u.current,e.snapshotListenOptions,a,o):hg(u.current,a,o);return function(){c()}},[u.current]),[l,i,r]};function mR(t){const e=oe.useContext(Fw),{text:n,uid:r,photoURL:i}=t.message,s=r===Ei.currentUser.uid?"sent":"received";return X.jsx(X.Fragment,{children:X.jsxs("div",{className:`${e.uid===r?"pl-2 ml-auto flex-row-reverse ":"mr-auto pr-2"} message
       ${s} m-2 flex  bg-gray-700 rounded-2xl w-fit }`,children:[X.jsx("img",{className:`${e.uid===r?"ml-2":"mr-2"} 
          w-6 h-6 flex flex-wrap  rounded-full`,src:i||"https://api.adorable.io/avatars/23/abott@adorable.png"}),X.jsx("p",{className:"text-1xl",children:n})]})})}function gR(){const e=new URL(document.location.href).searchParams.get("room")||"messages",n=oe.useRef(null),r=()=>n.current.scrollIntoView(),i=_w(Df),s=oe.useRef(),o=FA(i,e),a=XA(o,JA("createdAt","desc"),ZA(25)),[l]=pR(a,{idField:"id"}),[u,c]=oe.useState("");oe.useEffect(()=>{r()},[l]);const h=async d=>{d.preventDefault();const{uid:g,photoURL:y}=Ei.currentUser;await iR(o,{text:u,createdAt:Date.now(),uid:g,photoURL:y}),c(""),s.current.scrollIntoView({behavior:"smooth"})};return X.jsxs("div",{className:"flex flex-col",children:[X.jsxs("main",{className:"flex flex-col",children:[l&&l.docs.reverse().map(d=>X.jsx(mR,{message:d.data()},d.id)),X.jsx("span",{ref:s})]}),X.jsxs("form",{className:"flex",onSubmit:h,children:[X.jsx("button",{className:"ml-auto flex my-2  p-1.5 ",type:"submit",disabled:!u,children:"🕊️"}),X.jsx("input",{ref:n,className:` rounded-2xl py-1.5 px-2 m-2 flex bg-white border-2 border-black\r
                    text-black min-w-fit`,value:u,onChange:d=>c(d.target.value),placeholder:"say something nice"})]})]})}const Fw=oe.createContext("");function yR(){const[t]=qk(Ei);return X.jsxs("div",{className:"App mx-[250px] h-screen pb-8 overflow-y-auto bg-amber-100",children:[X.jsxs("header",{className:"sticky top-0 flex flex-1 flex-col justify-center items-center bg-amber-950",children:[X.jsx("div",{className:" relative w-fit m-5 text-5xl",children:"⚛️🔥💬"}),X.jsx(lR,{})]}),X.jsx(Fw.Provider,{value:t,children:X.jsx("section",{children:t?X.jsx(gR,{}):X.jsx(aR,{})})})]})}Xu.createRoot(document.getElementById("root")).render(X.jsx(tE.StrictMode,{children:X.jsx(yR,{})}));
